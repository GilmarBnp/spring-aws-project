...
class PersonServiceTests {
	/*
	 * @SpyBean MockPerson input;
	 * 
	 * @Autowired private PersonService service;
	 * 
	 * @MockBean PersonRepository repository;
	 * 
	 * @BeforeEach void setUpMockes() throws Exception { System.out.println(); input
	 * = new MockPerson(); MockitoAnnotations.openMocks(this);
	 * 
	 * }
	 * 
	 * @Test void testFindById() throws Exception { Person person =
	 * input.mockEntity(2);
	 * 
	 * person.setId(1L);
	 * 
	 ...
	 * contains("links: [<http://localhost/api/person/1>;rel=\"self\"]"));
	 * 
	 * assertEquals("Addres Test2", result.getAddress());
	 * assertEquals("First Name Test2", result.getFirstName());
	 * assertEquals("Last Name Test2", result.getLastName()); assertEquals("Male",
	 * result.getGender()); }
	 * 
	 * @Test void testCreate() throws Exception { Person entity =
	 * input.mockEntity(2); Person persisted = entity; entity.setId(1L);
	 * 
	 * PersonVO vo = input.mockVO(2); vo.setId(1L);
	 * 
	 ...
	 * result.getGender()); }
	 * 
	 * @Test void testCreateWithNullPerson() throws Exception {
	 * 
	 ...
	 * 
	 * @Test void testUpdate() throws Exception { Person entity =
	 * input.mockEntity(2); entity.setId(1L);
	 * 
	 * Person persisted = entity; entity.setId(1L);
	 * 
	 * PersonVO vo = input.mockVO(2); vo.setId(1L);
	 * 
	 ...
	 * result.getGender()); }
	 * 
	 * @Test void testUpdateWithNullPerson() throws Exception {
	 * 
	 * Exception exception = assertThrows(RequiredObjetNullException.class, () -> {
	 * service.update(null); });
	 * 
	 ...
	 * assertTrue(messageReceived.contains(expectedMessage)); }
	 * 
	 * @Test void testDelete() { Person entity = input.mockEntity(2);
	 * entity.setId(1L);
	 * 
	 * Person persisted = entity; persisted.setId(1L);
	 * 
	 * PersonVO vo = input.mockVO(2); vo.setId(1L);
	 * 
